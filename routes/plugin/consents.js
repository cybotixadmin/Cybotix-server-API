...
module.exports = function (app, connection) {
    ...
    // JSON Schema
    const plugin_user_post_consent_json_schema = {
        type: 'object',
        properties: {
            content: {
                type: 'string',
    ...
    app.post('/plugin_user_post_concent', (req, res) => {
        console.debug("/plugin_user_post_consent");
        try {
            ...
            const valid = ajv.validate(plugin_user_post_consent_json_schema, req.body);
